...
{
    public partial class Form_Volkswagen_Arteon : Form
    {
        readonly Panel[] Sites = new Panel[5];
        int num = 1;
        public Form_Volkswagen_Arteon()
        {
            InitializeComponent();
            Sites[0] = site_1;
            Sites[1] = site_2;
        ...
        private void Form_Volkswagen_Arteon_MouseDown(object sender, MouseEventArgs e)
        {
