...
{
    public partial class Form_Volkswagen_AtlasCrossSport : Form
    {
        readonly Panel[] Sites = new Panel[5];
        int num = 1;
        public Form_Volkswagen_AtlasCrossSport()
        {
            InitializeComponent();
            Sites[0] = site_1;
            Sites[1] = site_2;
        ...
        private void Form_Volkswagen_AtlasCrossSport_MouseDown(object sender, MouseEventArgs e)
        {
            base.Capture = false;
